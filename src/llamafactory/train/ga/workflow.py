...
def run_ga(
    ...
    print("================Num of dataset: {}==================".format(len(dataset)))
    ...
    for name, param in model.named_parameters():
        if finetuning_args.freeze_experts_layers == True: # gating unlearning only
        ...
        if finetuning_args.freeze_gating_layers == True: # expert unlearning only
            if 'expert' in name:
                param.requires_grad = True
            else:
                param.requires_grad = False
