...
class FreezeArguments:
    ...
    freeze_experts_layers: bool = field(
        default=False,
        metadata={
            "help": (
                "experts layers to be set as non-trainable "
            )
        },
    )
    freeze_gating_layers: bool = field(
        default=False,
        metadata={
            "help": (
                "gating layers to be set as non-trainable "
            )
        },
    )
    expert_training_mode: int = field(
        default=0,
        metadata={
            "help": (
                "expert configs settings for ablation study (11: deepseek wmdp-cyber smallest 6, 12: deepseek wmdp-cyber largest 6, 13: deepseek wmdp-cyber top0.2,"
            )
        },
    )
...
class FinetuningArguments(FreezeArguments, LoraArguments, RLHFArguments, GaloreArguments, BAdamArgument):
    ...
    chosen_gating_loss: float = field(
        default=1.0,
        metadata={
            "help": (
                "loss for gating layer to choose specific experts"
            )
        },
    )
    retain_gating_loss: float = field(
        default=10.0,
        metadata={
            "help": (
                "loss for gating layer to choose specific experts"
